use libduckdb_sys::{duckdb_aggregate_state, duckdb_data_chunk, duckdb_function_info, duckdb_vector, idx_t};
use quack_rs::prelude::{AggregateFunctionBuilder, AggregateState, ExtensionError, FfiState, TypeId, VectorReader, VectorWriter};
...
pub unsafe fn register_aggregate_demo(con: libduckdb_sys::duckdb_connection) -> Result<(), ExtensionError> {
    unsafe {
