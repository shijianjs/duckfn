...
//     （src/duck_columns.rs::read_columns 返回 Option），任一参数为 NULL
...
//
// 适配层（src/functions/scalar_function_adapter.rs::null_handling）默认
...
//
// 适配层（src/functions/scalar_function_adapter.rs::volatile）默认返回 false，
