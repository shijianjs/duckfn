...
/// 让公共代码拿到 `#[duck_copy_from_function]` 的文档参数。
///
/// Hands `#[duck_copy_from_function]`'s documentation arguments to the shared code.
impl DuckDocArgsProvider for DuckCopyFromFunctionArgs {
